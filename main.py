...
import torch as t
import models
from data.dataset import GenderData
...
def Visualizer(**kwargs):
    ...
    # data
    test_data = GenderData(opt.visualize_data_root, test=True)
...
def test(**kwargs):
    ...
    # data
    train_data = GenderData(opt.test_data_root,test=True)
...
def test(**kwargs):
    ...
    # data
    test_data = GenderData(opt.test_data_root,test=True)
    test_dataloader = DataLoader(test_data,batch_size=opt.batch_size,shuffle=True,num_workers=opt.num_workers)
    #print(test_dataloader)
    print("come")
    results = []
    ...
    write_csv(results,opt.result_file)
    print(results)
    val_data = GenderData(opt.test_data_root,train=False)
...
def train(**kwargs):
    ...
    train_data = GenderData(opt.train_data_root,train=True)
    val_data = GenderData(opt.train_data_root,train=False)
